...
* NOTE: you can also mix and match 2 launch types when creating a cluster
    - ![alt text](images/ecsimage-17.png)
...
* NOTE: it is possible to run a `task` without defining a service
    - ![alt text](images/ecsimage-16.png)
...
1. Create a `task defintion`:
    * ![alt text](images/ecsimage-4.png)
    - create with json
    ...
    - create without json
        ...
        * ![alt text](images/ecsimage-6.png)
        * define containers
            - ![alt text](images/ecsimage-7.png)
            * define env vars or files, can come from s3, secret manager or parameter store
                - ![alt text](images/ecsimage-8.png)
