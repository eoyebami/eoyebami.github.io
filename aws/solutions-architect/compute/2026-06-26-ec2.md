...
* AWS `ec2` has a variety of different pricing options
    ...
    4. `Reserved Instances`: same as `savings plan` but instead of committing to spending a certain amount per month, your comitting to use a certain amount of compute power per month in exchange for discounted prices
