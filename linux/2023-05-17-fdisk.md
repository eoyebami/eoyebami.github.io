...
* To persist mount on reboot, go over [this](https://oneuptime.com/blog/post/2026-03-02-how-to-configure-persistent-mounts-with-etc-fstab-on-ubuntu/view) doc

* NOTE: to check if there is a `fs` on a block device run: `sudo file -s /dev/<block-device-name>`
